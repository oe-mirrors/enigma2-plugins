...
class Calendar(ConfigListScreen, Screen):
	...
	<screen name="Calendar" position="40,55" size="1200,650" title=" " >
		...
		<widget name="w1" position="55,40" size="40,40" font="Regular;22" halign="center" valign="center" backgroundColor="#00808080" />
		<widget name="w2" position="100,40" size="40,40" font="Regular;22" halign="center" valign="center" backgroundColor="#00808080" />
		<widget name="w3" position="145,40" size="40,40" font="Regular;22" halign="center" valign="center" backgroundColor="#00808080" />
		<widget name="w4" position="190,40" size="40,40" font="Regular;22" halign="center" valign="center" backgroundColor="#00808080" />
		<widget name="w5" position="235,40" size="40,40" font="Regular;22" halign="center" valign="center" backgroundColor="#00808080" />
		<widget name="w6" position="280,40" size="40,40" font="Regular;22" halign="center" valign="center" backgroundColor="#00808080" />
		<widget name="w7" position="325,40" size="40,40" font="Regular;22" halign="center" valign="center" backgroundColor="#00808080" />

		<widget name="wn0" position="10,85" size="40,40" font="Regular;20" halign="center" valign="center" backgroundColor="#00808080" />
		<widget name="wn1" position="10,130" size="40,40" font="Regular;22" halign="center" valign="center" backgroundColor="#00808080" />
		<widget name="wn2" position="10,175" size="40,40" font="Regular;22" halign="center" valign="center" backgroundColor="#00808080" />
		<widget name="wn3" position="10,220" size="40,40" font="Regular;22" halign="center" valign="center" backgroundColor="#00808080" />
		<widget name="wn4" position="10,265" size="40,40" font="Regular;22" halign="center" valign="center" backgroundColor="#00808080" />
		<widget name="wn5" position="10,310" size="40,40" font="Regular;22" halign="center" valign="center" backgroundColor="#00808080" />
	...
	def __init__(self, session):
		...
		self["shortcuts"] = ActionMap(["OkCancelActions", "ColorActions", "DirectionActions", "MenuActions", "EPGSelectActions"], 
		{ "cancel": self.exit,
		"red": self.prevmonth,
...
class ConfigCalendar(ConfigListScreen, Screen):
	skin = """
	<!-- Config Calendar -->
	<screen name="ConfigCalendar" position="center,160" size="750,370" title="Calendar config">
